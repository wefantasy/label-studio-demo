...
python ../tools/train.py fcos_common.py
...
@REM python ../detect.py --out_path D:\ProgramData\SyncThing\Work\000000创世纪\炼体\kingcoco128\work_dir\detect ^
@REM     D:\ProgramData\SyncThing\Work\000000创世纪\炼体\kingcoco128\test.mp4 ^
@REM     fcos_common.py ^
@REM     D:\ProgramData\SyncThing\Work\000000创世纪\炼体\kingcoco128\work_dir\latest.pth 